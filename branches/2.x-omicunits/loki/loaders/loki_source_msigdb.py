...
class Source_msigdb(loki_source.Source):
	...
	def update(self, options):
		...
		listGID = self.addTypedGroups(gtypeID['pathway'], ((label,None) for label in listGroup))
		...
		self.addGroupMemberNamespacedNames(namespaceID['entrez_gid'], ((groupGID[label],n,entrezID) for label,n,entrezID in entrezAssoc))
		self.log(" OK\n")
	#update()
